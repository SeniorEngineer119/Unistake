    ...
    <div className="one-column-form centerform">
      ...
      <div className="centerform_subform mt-3">
        <div className="btn-form-intro">
          <span role="img" aria-label="star">⭐&nbsp;&nbsp;</span>Locking up your multipler will be result in the iriversable
          locking of all tokens in your balance. Each additional
          lock up will restart the lock up period of all tokens. 
        </div>
      </div>
    </div>
  );
