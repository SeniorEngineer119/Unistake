    ...
    <div className="one-column-form centerform">
      ...
      <div className="centerform_subform mt-3">
        <div className="btn-form-intro">         
          <span role="img" aria-label="star">⭐&nbsp;&nbsp;</span>Top ups will reach maturity after 24 hours at which time
          you can transfer them to your multiplier. Note: Adding
          additional top ups will restart the timer on pending top ups.
        </div>
      </div>
    </div>      
  );
