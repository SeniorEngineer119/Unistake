...
const CenterForm = ({ tab }) => {
  ...
  return (
    <div className="centerform-two-columns-container centerform">
      <div className="centerform_subform d-sm-none d-md-block">
        <div className="row">
      ...
      <div className="centerform_subform d-sm-block d-md-none">
        <div className="row">
          <div className="col-lg-6">
            {/* // Add liquidity */}
            <div className="input-area-with-header no-border">
          ...
          <div className="col-lg-6">
            <div className="input-area-with-header mt-2 no-border">
              <div className="input-area-with-header_label">
                <h6>Select Staking Period</h6>
              </div>
            </div>

            <div className="input-area-with-header mt-2 w-100">
              <div className="input-area-with-header_area">
                <div className="">
                  <p>
                    30
            ...
            <div className="input-area-with-header mt-4 w-100">
              <div className="input-area-with-header_label ">
                Return in ETH based on length of stake
              </div>
              <div className="input-area-with-header_area">
