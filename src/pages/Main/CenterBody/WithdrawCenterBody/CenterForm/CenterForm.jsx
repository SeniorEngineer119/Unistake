    ...
    <div className="centerform-two-columns-container withdraw-container centerform">
      <div className="centerform_subform">
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="input-area mt-4">
              <div className="input-area_row">
                <div className="input-area_row_left_column">Available</div>
                <div className="input-area_row_right_column"></div>
              </div>
              <div className="input-area_row mt-5px">
                <div className="input-area_row_left_column">
                  <InputWithButton maxValue={0.011} />
        ...
        <div className="row mt-2">
          <div className="col-lg-12">
            <div className="input-area-with-header mt-3">
              <div className="input-area-with-header_label ">Lockup Period</div>
        ...
        <div className="row mt-3">
          <button className="btn-form-submit">Withdraw Staking Bonuses</button>
        </div>
      </div>
    </div>
  );
